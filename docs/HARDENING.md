...
### workflows/investigation_hub/download_evidence.py -- Six Production Features
...
python3 workflows/investigation_hub/download_evidence.py <inv_id> processes --delay 0.5

# No delay (fastest, higher throttle risk)
python3 workflows/investigation_hub/download_evidence.py <inv_id> processes --delay 0
```
